    ...
    public void dibujarArbol(Graphics2D g2d, Nodo nodo, int x, int y, int dimensionX, int dimensionY) {
        if (nodo != null) {
            ...
            if (nodo.izq1 != null) {
                ...
                dibujarArbol(g2d, nodo.izq1, x - dimensionX, y + dimensionY, dimensionX / 2, dimensionY);
            }

            // Dibuja la línea y llama recursivamente para el nodo derecho
            if (nodo.der1 != null) {
                g2d.drawLine(x, y, x + dimensionX, y + dimensionY);
                dibujarArbol(g2d, nodo.der1, x + dimensionX, y + dimensionY, dimensionX / 2, dimensionY);
            }
        }
}
}
